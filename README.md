...
**Phase 7 Progress**: Core vector operations complete with 497 tests passing. The library now supports:
...
- **Preprocessing**: zscore (z-score normalization/standardization for ML feature scaling)
